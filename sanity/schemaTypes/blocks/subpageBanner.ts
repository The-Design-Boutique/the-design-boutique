...
export const subpageBanner = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'variant', title: 'Variant', type: 'string', initialValue: 'photo', options: { list: [{ title: 'Photo hero', value: 'photo' }, { title: 'Plain (black + leaf, left-aligned)', value: 'plain' }] } }),
