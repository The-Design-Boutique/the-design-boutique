...
const ICONS: Record<string, string> = {
  ...
  twitter: 'M18.9 2h3.3l-7.2 8.3L23.5 22h-6.6l-5.2-6.8L5.8 22H2.5l7.7-8.8L2 2h6.8l4.7 6.2L18.9 2zm-1.2 18h1.8L7.4 3.9H5.5L17.7 20z',
      ...
      <div className="container container--wide">
        <div className="footer-top">
          ...
          <div className="footer-col">
            ...
            {phone ? <a className="footer-contact-line" href={`tel:${phone.replace(/[^0-9.]/g, '')}`}>{phone}</a> : null}
